...
public class TwoSumArrays {
    ...
    // Problem: Two Sum (GFG) / Two Sum (LeetCode 1)
    // Logic : - target diya hoga and ek array hoga jisme hame jo two elements ko add karke --> target wale number ke equal karna hai bs.
